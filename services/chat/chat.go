...
// func CreateMessageNew(user *models.User, chatSessionId string, message string) (*models.Message, *fiber.Error) {
// 	var chatSession *models.ChatSession
...
// 	response, err := http.Post("https://api.example.com/submit", "application/json", bytes.NewBuffer(jsonData))
// 	if err != nil {
